...
class FretTextStylesExtension
    extends ThemeExtension<FretTextStylesExtension> {
  ...
  @override
  FretTextStylesExtension copyWith({
    TextStyle? headingH1,
    TextStyle? headingH2,
    TextStyle? headingH3,
    TextStyle? headingH4,
  ...
  @override
  ThemeExtension<FretTextStylesExtension> lerp(
    covariant ThemeExtension<FretTextStylesExtension>? other,
    double t,
  ) {
    return this;
  }
